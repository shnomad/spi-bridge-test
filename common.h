...
{
    enum cmd{CMD_AFE_READY=0x60, CMD_START_MEASURE, CMD_STOP_MEASURE, CMD_DAC_OUT_WORK_VOLT, CMD_DAC_OUT_COUNTER_VOLT, CMD_DAC_OUT_WORK_BIT, CMD_DAC_OUT_COUNTER_BIT, CMD_DAC_CHECK, \
             CMD_FW_CHECK, CMD_CHECK_AFE_CONNECTED, CMD_BATTERY_CHECK, CMD_UNKNOWN=0xff};

    enum resp{RESP_AFE_READY_SUCCESS=0x0, RESP_START_MEASURE_SUCCESS, RESP_STOP_MEASURE_SUCCESS, RESP_DAC_OUT_WORK_SUCCESS, RESP_DAC_OUT_COUNTER_SUCCESS, RESP_DAC_CHECK_SUCCESS,  \
