...
struct Coding_Channel_Ctl
{
    enum cmd{CMD_AFE_READY=0x0, CMD_START_MEASURE, CMD_STOP_MEASURE, CMD_DAC_OUT_WORK, CMD_DAC_CHECK_WORK, CMD_DAC_OUT_COUNTER, CMD_DAC_CHECK_COUNTER, \
             CMD_FW_CHECK, CMD_BATTERY_CHECK, CMD_UNKNOWN=0xff};
    ...
    enum resp{RESP_AFE_READY_SUCCESS=0x0, RESP_START_MEASURE_SUCCESS, RESP_STOP_MEASURE_SUCCESS, RESP_DAC_OUT_WORK_SUCCESS, RESP_DAC_CHECK_WORK_SUCCESS,  \
              RESP_DAC_OUT_COUNTER_SUCCESS, RESP_DAC_CHECK_COUNTER_SUCCESS, RESP_FW_CHECK_SUCCESS, RESP_BATTERY_CHECK_SUCCESS,  \
