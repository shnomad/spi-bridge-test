...
struct Coding_Channel_Ctl
{
    ...
    enum resp{RESP_AFE_READY_SUCCESS=0x0, RESP_START_MEASURE_SUCCESS, RESP_STOP_MEASURE_SUCCESS, RESP_DAC_OUT_WORK_SUCCESS, RESP_DAC_CHECK_WORK_SUCCESS,  \
             RESP_DAC_OUT_COUNTER_SUCCESS, RESP_DAC_CHECK_COUNTER_SUCCESS, RESP_MEASURED_ADC_VALUE, RESP_SOCKET_CONNECTED=0x80, RESP_BATTERY_CHECK_SUCCESS, RESP_FW_CHECK_SUCCESS, \
